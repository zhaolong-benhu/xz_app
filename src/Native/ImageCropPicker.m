...
#define ERROR_PICKER_NO_CAMERA_PERMISSION_KEY @"没有开启摄像头权限"
#define ERROR_PICKER_NO_CAMERA_PERMISSION_MSG @"用户不允许摄像头权限"

#define ERROR_PICKER_UNAUTHORIZED_KEY @"ERROR_PICKER_UNAUTHORIZED_KEY"
#define ERROR_PICKER_UNAUTHORIZED_MSG @"无法进入图片"

#define ERROR_PICKER_CANCEL_KEY @"取消选择"
#define ERROR_PICKER_CANCEL_MSG @"用户取消选择"

#define ERROR_PICKER_NO_DATA_KEY @"没有数据"
#define ERROR_PICKER_NO_DATA_MSG @"没有图片"

#define ERROR_CROPPER_IMAGE_NOT_FOUND_KEY @"图片没有找到"
#define ERROR_CROPPER_IMAGE_NOT_FOUND_MSG @"指定路径内没有图片"
...
#define ERROR_CANNOT_SAVE_IMAGE_KEY @"无法保存图片"
#define ERROR_CANNOT_SAVE_IMAGE_MSG @"无法保存图片，保存临时图片错误"

#define ERROR_CANNOT_PROCESS_VIDEO_KEY @"无法处理视频"
#define ERROR_CANNOT_PROCESS_VIDEO_MSG @"无法处理视频数据"
