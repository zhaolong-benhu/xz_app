...
//        setRateModifier(mRate);
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        ...
        Log.e("xkk","videoview->"+Events.EVENT_ERROR.toString()+what+"--->"+extra);
...
//        Log.e("xkk","videoview521");
//        if (mMediaPlayer != null && !mPlayInBackground) {
//            new Handler().post(new Runnable() {
//                @Override
//                public void run() {
//                    // Restore original state
//                    Log.e("xkk","videoview527  mActiveStatePauseStatus-"+mActiveStatePauseStatus+"url--->"+mMediaPlayer.isPlaying());
